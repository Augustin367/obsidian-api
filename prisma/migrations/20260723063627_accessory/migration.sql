/*
  ...
  - The values [ACESSORY] on the enum `ProductCategory` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ProductCategory_new" AS ENUM ('IPHONE', 'IPAD', 'MACBOOK', 'APPLE_WATCH', 'AIRPODS', 'ACCESSORY');
